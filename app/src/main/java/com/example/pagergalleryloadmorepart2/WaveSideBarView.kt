...
class WaveSideBarView @JvmOverloads constructor(
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        mLargeTextSize =
            context.resources.getDimensionPixelSize(R.dimen.large_textSize_sidebar).toFloat()
        ...
        if (attrs != null) {
            ...
            mTextColorChoose =
                a.getColor(R.styleable.WaveSideBarView_sidebarChooseTextColor, mTextColorChoose)
            ...
            mRadius = a.getInt(
                ...
                context.resources.getDimensionPixelSize(R.dimen.radius_sidebar)
            )
            mBallRadius = a.getInt(
                R.styleable.WaveSideBarView_sidebarBallRadius,
                context.resources.getDimensionPixelSize(R.dimen.ball_radius_sidebar)
            )
            a.recycle()
        }
        mWavePaint = Paint()
    ...
    //fun setOnTouchLetterChangeListener(WaveSideBarView.OnTouchLetterChangeListener)
